...
interface GetUserProfilePosts {
  data:any;
}
    export default function GetUserProfilePosts({data}:GetUserProfilePosts) {
...
const fetchPosts = async () => {
  ...
  try {
      const response = await axiosInstance.get<ApiResponse>(`/post/get-user-posts/${data?._id}`, {
