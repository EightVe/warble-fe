...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-white">
      {/* Navigation */}
      <nav className="flex items-center justify-between p-4 md:p-6 absolute w-full top-0 z-50">
        <div></div>
        <img 
          src={AuthBG} 
          alt="logo" 
      ...
      {/* Hero Section */}
      <div className="relative mx-auto max-w-7xl px-10 py-12 md:py-24">
        <div className="grid gap-12 md:grid-cols-2">
          ...
          <div className="relative h-[600px]">
            ...
            <motion.div
              className="absolute left-20 top-40 rounded-full bg-red-100 p-4"
              animate={{
                y: [0, -15, 0],
                x: [0, 10, 0],
                rotate: [0, 10, 0],
            ...
            <motion.div
              className="absolute left-25 top-60 rounded-full bg-red-100 p-4"
              animate={{
                y: [0, -4, 0],
                x: [0, 15, 0],
                rotate: [0, 7, 0],
