...
export default function Signup() {
  return (
    ...
    <Helmet>
    <title>Warble - Sign Up</title>
    <meta name="description" content="Join Warble Chat – create your account and connect with friends now!" />
    <meta property="og:title" content="Warble - Sign Up" />
    <meta property="og:site_name" content="Warble Chat" />
    <meta property="og:url" content="https://warble.chat/auth/signup" />
    <link rel="canonical" href="https://warble.chat/auth/signup" />
  </Helmet>
